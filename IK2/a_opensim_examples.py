...
if __name__ == '__main__':
    ...
    #folder_path = "C:\\Users\\alow056.UOA\\OneDrive - The University of Auckland\\UOA\\PhD\\Research\\year " \
     #             "3\\Gait\\Participants\\participant_01\\Return\\"  # path to data
    folder_path = r"C:\Users\schb998\MyData\test"
    ...
    trc_file = r"C:\Users\schb998\MyData\test\participant gait"
    test_trc = r"C:\Users\schb998\MyData\test\participant gait"
    ...
    trc = [f for f in os.listdir(test_trc) if f.endswith(".trc")]
    ...
    for file in trc: # For loop, runs through the variable trc and stores current index as "file"
        ikconfig = { #Looking up the files. Therefore, put in path for the file
            ...
            "model_file": "{0}/participant model/{1}_scaled.osim".format(folder_path, participant), #Specific model file
            # "trc_file": "{0}{1}/{2}".format(folder_path, data_directory, file),
            "trc_file": "{0}/{1}".format(trc_file, file),
            "output_motion_file": outputdir_for_ik + "{0}.sto".format(file[:file.index(".trc")]),
            "template": r"C:\Users\schb998\MyData\test\IKSetups.xml"}
